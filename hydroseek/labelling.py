...
# The three metadata columns that always appear before the label columns
METADATA_COLUMNS = ["ChunkNo", "StartTime_sec", "EndTime_sec"]
# The two columns appended after the label columns
SUFFIX_COLUMNS   = ["Confidence", "Comment"]
...
def append_row(
    ...
    row_data = [chunk_no, start_time, end_time] + checkbox_values + [confidence, comment]
